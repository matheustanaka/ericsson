...
*/}}
{{- define "eric-bss-eb-dmf.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-dmf.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-dmf.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-dmf.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-dmf.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-dmf.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-dmf.checkPodUserLoginData" -}}
