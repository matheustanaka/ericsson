...
*/}}
{{- define "eric-bss-eb-vmdrep.name" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.chart" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-vmdrep.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-vmdrep.checkPodUserLoginData" -}}
