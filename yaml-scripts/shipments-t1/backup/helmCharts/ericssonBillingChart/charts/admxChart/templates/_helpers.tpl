...
*/}}
{{- define "eric-bss-eb-admx.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-admx.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-admx.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-admx.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-admx.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-admx.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-admx.checkPodUserLoginData" -}}
