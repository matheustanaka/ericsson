...
*/}}
{{- define "eric-bss-eb-cdh.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-cdh.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-cdh.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-cdh.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-cdh.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-cdh.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-cdh.checkPodUserLoginData" -}}
