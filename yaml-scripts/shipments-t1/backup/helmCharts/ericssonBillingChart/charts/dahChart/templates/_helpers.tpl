...
*/}}
{{- define "eric-bss-eb-dah.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-dah.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-dah.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-dah.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-dah.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-dah.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-dah.checkPodUserLoginData" -}}
