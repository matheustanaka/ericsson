...
*/}}
{{- define "eric-bss-eb-cch.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-cch.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-cch.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-cch.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-cch.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-cch.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-cch.checkPodUserLoginData" -}}
