...
*/}}
{{- define "eric-bss-eb-ff.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-ff.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-ff.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-ff.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-ff.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-ff.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-ff.checkPodUserLoginData" -}}
