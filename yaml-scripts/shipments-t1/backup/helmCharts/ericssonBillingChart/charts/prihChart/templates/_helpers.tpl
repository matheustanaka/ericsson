...
*/}}
{{- define "eric-bss-eb-prih.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-prih.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-prih.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-prih.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-prih.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-prih.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-prih.checkPodUserLoginData" -}}
