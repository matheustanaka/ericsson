...
*/}}
{{- define "eric-bss-eb-ax.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-ax.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-ax.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-ax.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-ax.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-ax.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-ax.checkPodUserLoginData" -}}
