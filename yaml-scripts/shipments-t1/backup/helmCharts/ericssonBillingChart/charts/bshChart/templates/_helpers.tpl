...
*/}}
{{- define "eric-bss-eb-bsh.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-bsh.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-bsh.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-bsh.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-bsh.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-bsh.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-bsh.checkPodUserLoginData" -}}
