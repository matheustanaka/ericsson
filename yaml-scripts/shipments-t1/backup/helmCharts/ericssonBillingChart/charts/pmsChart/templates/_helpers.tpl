...
*/}}
{{- define "eric-bss-eb-pms.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-pms.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-pms.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-pms.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-pms.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-pms.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-pms.checkPodUserLoginData" -}}
