...
*/}}
{{- define "eric-bss-eb-bgh.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-bgh.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-bgh.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-bgh.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-bgh.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-bgh.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-bgh.checkPodUserLoginData" -}}
