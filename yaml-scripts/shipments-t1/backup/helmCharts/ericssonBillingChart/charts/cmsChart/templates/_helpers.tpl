...
*/}}
{{- define "eric-bss-eb-cms.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-cms.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-cms.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-cms.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-cms.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-cms.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-cms.checkPodUserLoginData" -}}
