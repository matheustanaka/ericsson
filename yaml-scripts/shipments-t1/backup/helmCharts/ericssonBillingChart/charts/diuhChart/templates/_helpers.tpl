...
*/}}
{{- define "eric-bss-eb-diuh.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-diuh.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-diuh.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-diuh.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-diuh.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-diuh.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-diuh.checkPodUserLoginData" -}}
