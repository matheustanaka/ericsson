...
*/}}
{{- define "eric-bss-eb-dly.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-dly.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-dly.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-dly.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-dly.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-dly.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-dly.checkPodUserLoginData" -}}
