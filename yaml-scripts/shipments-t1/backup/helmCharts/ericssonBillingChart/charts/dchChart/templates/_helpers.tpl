...
*/}}
{{- define "eric-bss-eb-dch.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-dch.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-dch.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-dch.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-dch.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-dch.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-dch.checkPodUserLoginData" -}}
