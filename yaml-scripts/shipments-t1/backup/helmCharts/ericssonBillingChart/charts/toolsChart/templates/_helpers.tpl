...
*/}}
{{- define "eric-bss-eb-tools.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-tools.chart" -}}
...
*/}}
{{- define "eric-bss-eb-tools.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-tools.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-tools.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-tools.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-tools.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-tools.checkPodUserLoginData" -}}
