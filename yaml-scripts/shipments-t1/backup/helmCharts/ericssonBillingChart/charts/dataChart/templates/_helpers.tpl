...
*/}}
{{- define "eric-bss-eb-data.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-data.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-data.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-data.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-data.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-data.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-data.checkPodUserLoginData" -}}
...
{{/*
Inserts annotations into a service.
*/}}
{{- define "eric-bss-eb-data.serviceAnnotations" -}}
