...
*/}}
{{- define "eric-bss-eb-lem.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-lem.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-lem.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-lem.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-lem.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-lem.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-lem.checkPodUserLoginData" -}}
