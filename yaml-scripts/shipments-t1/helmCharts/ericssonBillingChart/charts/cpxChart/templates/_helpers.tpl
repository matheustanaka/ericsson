...
*/}}
{{- define "eric-bss-eb-cpx.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-cpx.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-cpx.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-cpx.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-cpx.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-cpx.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-cpx.checkPodUserLoginData" -}}
