...
*/}}
{{- define "eric-bss-eb-cx.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-cx.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-cx.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-cx.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-cx.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-cx.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-cx.checkPodUserLoginData" -}}
