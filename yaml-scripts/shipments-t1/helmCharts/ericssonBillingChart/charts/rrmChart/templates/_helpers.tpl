...
*/}}
{{- define "eric-bss-eb-rrm.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-rrm.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-rrm.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-rrm.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-rrm.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-rrm.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-rrm.checkPodUserLoginData" -}}
