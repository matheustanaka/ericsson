...
*/}}
{{- define "eric-bss-eb-foh.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-foh.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-foh.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-foh.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-foh.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-foh.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-foh.checkPodUserLoginData" -}}
