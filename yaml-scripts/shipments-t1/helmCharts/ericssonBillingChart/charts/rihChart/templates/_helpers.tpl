...
*/}}
{{- define "eric-bss-eb-rih.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-rih.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-rih.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-rih.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-rih.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-rih.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-rih.checkPodUserLoginData" -}}
