...
*/}}
{{- define "eric-bss-eb-wex.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-wex.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-wex.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-wex.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-wex.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-wex.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-wex.checkPodUserLoginData" -}}
