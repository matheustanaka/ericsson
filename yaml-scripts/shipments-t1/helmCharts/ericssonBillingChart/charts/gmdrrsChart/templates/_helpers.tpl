...
*/}}
{{- define "eric-bss-eb-gmdrrs.name" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.chart" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-gmdrrs.checkPodUserLoginData" -}}
...
{{/*
Insert annotations into a service.
*/}}
{{- define "eric-bss-eb-gmdrrs.serviceAnnotations" -}}
    {{- if .Values.global.addressPoolName.TRF -}}
metallb.universe.tf/address-pool: {{.Values.global.addressPoolName.TRF}}
    {{- end -}}
    {{- range $key, $val := .Values.global.loadBalancerAnnotations }}
{{ $key }}: {{ $val | quote }}
    {{- end }}
{{- end -}}