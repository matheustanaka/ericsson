...
*/}}
{{- define "eric-bss-eb-dcx.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-dcx.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-dcx.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-dcx.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-dcx.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-dcx.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-dcx.checkPodUserLoginData" -}}
