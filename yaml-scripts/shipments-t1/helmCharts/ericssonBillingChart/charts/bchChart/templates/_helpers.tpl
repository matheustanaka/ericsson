...
*/}}
{{- define "eric-bss-eb-bch.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-bch.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-bch.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-bch.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-bch.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-bch.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-bch.checkPodUserLoginData" -}}
