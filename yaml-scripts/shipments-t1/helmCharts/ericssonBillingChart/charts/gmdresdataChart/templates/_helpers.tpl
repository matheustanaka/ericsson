...
*/}}
{{- define "eric-bss-eb-gmdresdata.name" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.chart" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-gmdresdata.checkPodUserLoginData" -}}
