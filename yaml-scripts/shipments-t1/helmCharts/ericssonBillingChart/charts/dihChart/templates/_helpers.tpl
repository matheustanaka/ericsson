...
*/}}
{{- define "eric-bss-eb-dih.fullname" -}}
...
*/}}
{{- define "eric-bss-eb-dih.kubernetesIoInfo" -}}
...
*/}}
{{- define "eric-bss-eb-dih.productInfo" }}
...
*/}}
{{- define "eric-bss-eb-dih.repoPath" -}}
    {{- $repoPath := "" -}}
...
*/}}
{{- define "eric-bss-eb-dih.pullPolicy" -}}
...
*/}}
{{- define "eric-bss-eb-dih.registryUrl" -}}
    {{- $registryUrl := "" -}}
...
*/}}
{{- define "eric-bss-eb-dih.checkPodUserLoginData" -}}
